...
- Help with VPN, WiFi, password reset, Outlook, laptop issues
 ...
 return (
  <div className="min-h-screen bg-black text-white flex relative overflow-hidden">
    ...
    {/* SIDEBAR */}
    <div className="w-72 bg-white/5 backdrop-blur-xl border-r border-white/10 p-6 z-10">
    ...
    <div className="flex-1 flex flex-col z-10">
      ...
      {/* QUICK ACTIONS */}
      <div className="p-5 flex gap-3 flex-wrap border-b border-white/10">
        ...
        {[
          ...
          <button
            key={index}
            className="bg-white/5 border border-white/10 hover:bg-cyan-500 hover:border-cyan-500 transition-all px-5 py-3 rounded-2xl text-sm"
          >
            {item}
          </button>
        ))}
      ...
      <div className="flex-1 overflow-auto p-8 space-y-6">
        ...
        {messages.map((msg, index) => (
          ...
          >
            <div
              className={`max-w-2xl p-5 rounded-3xl border ${
                msg.role === "user"
      ...
      {/* FOOTER */}
      <div className="border-t border-white/10 p-8 flex flex-col items-center gap-5 backdrop-blur-xl bg-white/5">
        ...
        <button
          ...
          disabled={loading}
          className={`w-28 h-28 rounded-full flex items-center justify-center transition-all duration-300 shadow-[0_0_60px_rgba(0,255,255,0.5)] relative ${
            listening
